...
local Window = Library.CreateLib("TrueMadness hub", "BloodTheme")
...
MainSection:NewLabel("Z combo 1")
MainSection:NewLabel("x combo 2")
MainSection:NewLabel("c combo 3")
MainSection:NewLabel("V combo 4")
MainSection:NewLabel("b combo 5")
...
PlayerSection:NewButton("R6", "R6 reanimation", function()
...
ScriptsSection:NewButton("Dex V2", "its the studio Explopler", function()
    CreateGui = function()
...
ScriptsSection:NewButton("ChatHax", "Opens up chathax", function()
    loadstring(game:HttpGet(('https://pastebin.com/BcMycyFX')))()
end)

ScriptsSection:NewButton("Universal Hub", "Bro the title says it", function()
